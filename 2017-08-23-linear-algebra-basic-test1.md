...
\end{bmatrix} 
\end{aligned= \frac{\partial}{\partial \mathbf{x}} \nabla f = \mathbf{J}(\nabla f) \in \mathbb{R}^{n \times n}
TEST-TEST-TEST
<br/>
...
* TEST-TEST-TEST{\scriptsize \bullet} ~~\dfrac{\partial}{\partial \mathbf{x}} \mathbf{w}^\mathsf{T} \mathbf{x}\dfrac{\partial}{\partial \mathbf{x}} \mathbf{x}^\mathsf{T} \mathbf{w} = \mathbf{w}$

* TEST-TEST-TEST{\scriptsize \bullet} ~~\dfrac{\partial}{\partial \mathbf{x}} \mathbf{x}^\mathsf{T} \mathbf{A} \mathbf{x} = (\mathbf{A} + \mathbf{A}^\mathsf{T}) ~\mathbf{x}$

* TEST-TEST-TEST{\scriptsize \bullet} ~~\dfrac{\partial}{\partial \mathbf{A}} \text{tr}(\mathbf{B}\mathbf{A}) = \mathbf{B}^\mathsf{T}$
