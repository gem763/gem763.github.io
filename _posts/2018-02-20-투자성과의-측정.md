...
<div class="math"><script type="math/tex; mode=display">
\mathbf{HR} = \frac{\mathbf{n}(\mathbf{R}^+)}{\mathbf{n}(\mathbf{R})}
</script></div>

여기서 <span><script type="math/tex">\mathbf{n}(\cdot)</script></span>은 해당 집합의 원소의 갯수를 세어주는 연산자이다. 
...
<div class="math"><script type="math/tex; mode=display">
\mathbf{LP} \equiv \frac{\mathbf{n}(\mathbf{CAGR}_\ell^+)}{\mathbf{n}(\mathbf{CAGR}_\ell)}
</script></div>
