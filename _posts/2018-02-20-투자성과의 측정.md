...
### Loss probability
나의 투자전략에 <span><script type="math/tex">\ell</script></span> **기간동안 투자했을 때의 손실 가능성**을 의미한다. <span><script type="math/tex">\mathbf{CAGR}_\ell</script></span> 의 확률밀도함수에서 0 이하의 넓이를 계산하면 된다. 
